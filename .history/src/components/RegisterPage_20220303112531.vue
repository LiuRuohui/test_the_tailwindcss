    ...
    <div class="sm:max-w-xl sm:object-center sm:object-cover w-full space-y-8">
      ...
      <div class="rounded-md shadow-sm sm:text-xl">
        ...
        <div class="py-4 text-blue-800">
          ...
          <input id="passwd" name="passwd" type="passwd" autocomplete="current-passwd" required class="btn rounded-b-md  sm:text-xl" placeholder="请输入密码">
        </div>
        <div class="py-4 text-blue-800">
          <label for="passwd">再次输入密码:</label>
          <input id="passwd" name="passwd" type="passwd" autocomplete="current-passwd" required class="btn rounded-b-md sm:text-xl" placeholder="请再次输入密码">
        </div>
      </div>
