...
<div class="flex flex-row sm:mx-16 sm:my-20 sm:text-xl bg-indigo-300">
    ...
    <div class="sm:basis-2/3 bg-red-400 float">
        <div class="bg-blue-500">
            <div class="sm:">{{friends.name[1]}}</div>
            <div class="inline-block float-right"><img src="../assets/关闭按钮.svg" alt="关闭按钮" class="h-16 inline-block"></div>
            <img src="../assets/关闭按钮.svg" alt="关闭按钮" class="h-16 inline-block">
        </div>
    </div>
</div>
</template>
