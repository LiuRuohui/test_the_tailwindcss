...
<div class="flex flex-row sm:mx-16 sm:my-20 sm:text-xl bg-indigo-300">
    ...
    <div class="sm:basis-56 bg-red-300 overflow-auto">
        <div v-for="friend in friends.name" class="mt-4 sm:text-xl grid">
            <img src="../assets/好友.svg" alt="好友" class="h-16 my-2 m-l-2 float-left">
            <div class="sm:text-xl mt-2 inline-block float-left">好友</div> 
            <hr class="border-2"> 
        </div>
    </div>

    <div class="sm:basis-auto bg-red-400">
      <img src="../assets/好友.svg" alt="好友" class="h-16 my-2 m-l-2 inline-block">
      <span>div</span>
    </div>
</div>
</template>
