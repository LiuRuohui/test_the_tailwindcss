<template>
  <div class="relative min-h-screen flex">
    ...
    >
      ...
      <div
        class="md:flex md:items-center md:justify-center w-full sm:w-auto md:h-full md:w-2/5 xl:w-2/5 p-8 md:p-10 lg:p-14 sm:rounded-lg md:rounded-none bg-white"
      >
        <div class="max-w-md w-full mx-auto space-y-8">
          ...
          <form class="mt-8 space-y-6" action="#" method="POST">
            ...
            <div class="relative">
              <label class="ml-3 text-sm font-bold text-gray-700 tracking-wide">电子邮箱</label>
              <input
