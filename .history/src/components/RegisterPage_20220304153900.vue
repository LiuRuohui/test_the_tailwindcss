...
<div class="flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8c">
    ...
    <form class="mt-8 space-y-4" action="#" method="POST">
      ...
      <div class="sm:text-xl sm:mt-8">
        <input value="重置" type="button" @click="reset" class="btn group sm:text-xl text-center">
        <input value="重置" type="button" class="btn group sm:text-xl text-center">
        <br>
