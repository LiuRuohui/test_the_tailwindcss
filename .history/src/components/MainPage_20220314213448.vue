...
<div class="flex flex-row sm:mx-16 sm:my-20 sm:text-xl ">
    <div class="sm:basis-40 bg-indigo-100">
    ...
    <div class="sm:basis-52 bg-red-300 overflow-auto">
