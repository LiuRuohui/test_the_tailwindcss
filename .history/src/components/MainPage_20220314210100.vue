<template>
<div class="flex sm:mx-16 sm:my-20 sm:text-xl bg-indigo-300">
    <div class="sm:basis-36 ">
        <div class="grid grid-rows-3 sm:gap-6 gap-3">
            ...
            <div class="grid grid-rows-4 gap-16 bg-indigo-300 mt-4">
    ...
    <div class="sm:basis-48 bg-red-300 overflow-auto">
    ...
    <div class="sm:basis-3/4 bg-red-400">
