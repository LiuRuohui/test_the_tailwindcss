<template>
<div class="min-h-full  items-center justify-center py-8 px-4 sm:px-6 lg:px-8">
<div class="flex sm:mx-16 sm:my-20 sm:text-xl bg-indigo-100">
    <div class="sm:basis-40">
        <div class="grid grid-rows-3 sm:gap-6 gap-3 mt-2">
            <div class="row-span-2">
                <img src="../assets/用户.svg" alt="" class="my-2 sm:mt-4 h-20 w-2/3 mx-auto">
            </div>
            <div class="sm:text-3xl text-center m-auto">{{nickname}}</div>
            <div class="grid grid-rows-4 gap-16 bg-indigo-100 mt-4">
    ...
    <div class="sm:basis-56 bg-red-300 overflow-auto">
        <div v-for="friend in friends.name" class="my-4 sm:text-xl ">
            <img src="../assets/好友.svg" alt="好友" class="h-12 my-2 ml-4 inline-block">
