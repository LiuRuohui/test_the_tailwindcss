    ...
    <div class="sm:max-w-xl sm:object-center sm:object-cover w-full space-y-8">
      ...
      <div class="rounded-md shadow-sm sm:text-xl">
        <div class="py-4">
          ...
          <input id="email-address" name="email" type="email" autocomplete="email" required class="rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-t-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm" placeholder="请输入昵称">
        </div>
        <div class="py-4">
