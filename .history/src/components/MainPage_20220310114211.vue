...
<div class="flex flex-row sm:mx-16 sm:my-20 sm:text-xl bg-indigo-300">
    ...
    <div class="sm:basis-2/3 bg-red-400">
        <div class="bg-blue-500 h-24">
            <div class="sm:text-4xl float-left h-24 mt-6 ml-8">{{friends.name[1]}}</div>
            <div class="inline-block float-right"><img src="../assets/关闭按钮.svg" alt="关闭按钮" class="h-20 mt-2 mr-4"></div>
        </div>
    </div>
</div>
</template>
